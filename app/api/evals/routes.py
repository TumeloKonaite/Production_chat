    ...
    for index, experiment in enumerate(payload.experiments, start=1):
        ...
        experiments.append(
            RetrievalSweepExperiment(
                ...
                reranker_enabled=bool(experiment.reranker_enabled),
                reranker_type=experiment.reranker_type or ("llm" if experiment.reranker_enabled else "none"),
                reranker_model=_normalize_optional_string(experiment.reranker_model),
...
def _build_sweep_run_response(row: dict[str, Any]) -> RetrievalEvalSweepRunResponse:
    return RetrievalEvalSweepRunResponse(
        ...
        config={
            ...
            "query_rewriting": row.get("query_rewriting"),
            ...
            "reranker_initial_top_k": row.get("reranker_initial_top_k"),
            "reranker_final_top_k": row.get("reranker_final_top_k"),
